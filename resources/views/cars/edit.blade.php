    ...
    <div class="max-w-2xl mx-auto p-4 sm:p-6 lg:p-8">
        <form method="POST" action="{{ route('cars.update', $car) }}" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="car_model" id="car_model" placeholder="{{ __('Enter Car Model') }}"
            ...
            <div class="mb-4">
                ...
                <input type="text" name="car_make" id="car_make" placeholder="{{ __('Enter Car Make') }}"
                    class="block w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm"
                    value="{{ old('car_make', $car->car_make) }}" />
            ...
            <div class="mb-4">
                ...
                <input type="number" name="year" id="year" placeholder="{{ __('Enter Year') }}"
                    class="block w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm"
            ...
            <div class="mb-4">
                ...
                <input type="text" name="car_color" id="car_color" placeholder="{{ __('Enter Color') }}"
                    class="block w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm"
            ...
            <div class="mb-4">
                ...
                <input type="number" name="car_price" id="car_price" placeholder="{{ __('Enter Price') }}"
                    class="block w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm"
            ...
            <div class="mb-4">
                ...
                <input type="number" name="car_mileage" id="car_mileage" placeholder="{{ __('Enter car mileage') }}"
                    class="block w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm"
            ...
            <div class="mb-4">
                <label for="car_fuel"
                    class="block text-sm font-medium text-gray-700">{{ __('Fuel Consumption') }}</label>
                <input type="number" name="car_fuel" id="car_fuel" placeholder="{{ __('Enter fuel consumption') }}"
                    class="block w-full border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm"
            ...
            <div class="mb-4">
                <label for="images"
                    class="block text-sm font-medium text-gray-700">{{ __('Car Images (Select up to 5)') }}</label>
            ...
            <a href="{{ route('cars.index') }}">{{ __('Cancel') }}</a>
        </form>
    </div>
</x-app-layout>
